...
volume_3 = Dropout(.4)(volume_3)

volume_4 = MaxPooling2D((3,3), strides=(1,1), padding='same')(input_img)
volume_4 = Conv2D(32, (1,1), padding='same', activation='relu')(volume_4)
volume_4 = Dropout(.4)(volume_4)

# Concatenate all volumes of the Inception module
inception_module = keras.layers.concatenate([volume_1, volume_2, volume_3,
                                             volume_4], axis = 3)
inception_module = Conv2D(128, (5,5), padding='same', activation='relu')(inception_module)
inception_module = Dropout(.4)(inception_module)
inception_module = Conv2D(64, (3,3), padding='same', activation='relu')(inception_module)
inception_module = Dropout(.4)(inception_module)
inception_module = Conv2D(32, (1,1), padding='same', activation='relu')(inception_module)
